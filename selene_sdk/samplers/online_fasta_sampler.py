...
from ..targets import FastaFeatures


class OnlineFastaSampler(Sampler, metaclass=ABCMeta):
    """
    ...
    def __init__(self,
        ...
        """
        super(OnlineFastaSampler, self).__init__(
            features,
        ...
        self.target = FastaFeatures(target_path, self._features)
